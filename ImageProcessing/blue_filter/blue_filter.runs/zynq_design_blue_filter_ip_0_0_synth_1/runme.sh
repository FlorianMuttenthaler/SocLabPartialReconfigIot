...
HD_PWD='/home/soc-lab/Desktop/SoC-Lab/SocLabPartialReconfigIot/ImageProcessing/blue_filter/blue_filter.runs/zynq_design_blue_filter_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_design_blue_filter_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_blue_filter_ip_0_0.tcl
