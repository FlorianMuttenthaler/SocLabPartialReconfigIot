...
ISEStep( "vivado",
         "-log zynq_design_black_white_filter_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_black_white_filter_ip_0_0.tcl" );
