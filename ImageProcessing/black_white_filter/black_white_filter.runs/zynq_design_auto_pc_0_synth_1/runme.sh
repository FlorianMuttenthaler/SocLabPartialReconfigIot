...
HD_PWD='/home/soc-lab/Desktop/SoC-Lab/SocLabPartialReconfigIot/ImageProcessing/black_white_filter/black_white_filter.runs/zynq_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_auto_pc_0.tcl
