...
From Android, \gls{dpr} can be easily done by sending the path of the partial bitstream to the device driver. \Cref{lst:prandroid} shows how this is implemented.
